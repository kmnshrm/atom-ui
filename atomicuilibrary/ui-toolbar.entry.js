...
const Toolbar = class {
    ...
    render() {
        ...
        return (h(Host, { key: '6b33477b806940fbb98394621c375a70853128a9', class: hostClasses, style: stickyStyle, role: "toolbar", "aria-label": this.toolbarAriaLabel, "aria-disabled": this.disabled ? 'true' : null }, this.isMobile && (h("ui-button", { key: '12131b32e8813702f466625f77a38c3978bb4147', class: "toolbar-mobile-toggle", "aria-expanded": String(!this.isCollapsed), "aria-label": this.isCollapsed ? 'Expand toolbar' : 'Collapse toolbar', onButtonClick: () => { this.isCollapsed = !this.isCollapsed; }, variant: "ghost", icon: this.isCollapsed ? 'menu' : 'x', "icon-library": this.iconLibrary, iconOnly: true })), (!this.isMobile || !this.isCollapsed) && (h("div", { key: '3e203ab7c3349576bae4f42b906ec702b97b18af', class: "toolbar-body", style: bodyStyle, ref: el => this.toolbarBodyRef = el }, h("slot", { key: '5c2f402b9d318651a0007b3ed80064f711f6e3a5', name: "before" }), hasSchema ? (h("div", { class: "toolbar-zones" }, this.renderZone(this.parsedSchema.left ?? [], 'left'), this.zoneDividers && (this.parsedSchema.left?.length > 0) && (this.parsedSchema.center?.length > 0) && this.renderSeparator(), this.renderZone(this.parsedSchema.center ?? [], 'center'), this.zoneDividers && (this.parsedSchema.center?.length > 0) && (this.parsedSchema.right?.length > 0) && this.renderSeparator(), this.renderZone(this.parsedSchema.right ?? [], 'right'))) : (this.parsedItems.map(item => this.renderItem(item))), h("slot", { key: 'd8e7b2fec2cad8fe068792c0a4cb0e7b7d0b002e', name: "left" }), h("slot", { key: '4445e8c225d7249ddd65fe1164dc78a924d63530', name: "center" }), h("slot", { key: 'd590115edf7ff9d04cb0e36b5cac629b85901b09', name: "right" }), h("slot", { key: 'cf6631fd34e189258bea03f5b653ee4d766f3d78' }), this.overflowStrategy === 'dropdown' && this.renderOverflowMenu(), h("slot", { key: 'f97fe02b2756a3cbb7b82965d57e767597834ee7', name: "after" })))));
    }
