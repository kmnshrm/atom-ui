...
const Tooltip = class {
    ...
    render() {
        ...
        const tooltipContent = (h("div", { key: 'd08971e832d6bb9f6975de4162afaee0025d6d98', class: tooltipClasses, style: {
            ...
            }, ref: el => this.tooltipElement = el, onMouseEnter: this.handleTooltipMouseEnter, onMouseLeave: this.handleTooltipMouseLeave, role: "tooltip", "aria-live": "polite" }, this.closable && (h("ui-button", { key: '8744809203573938ea08f72665c75e63a9c37e79', variant: "ghost", class: "tooltip-close", onClick: this.handleClose, ariaLabel: "Close tooltip", icon: "x", iconLibrary: "lucide", iconOnly: true, size: "sm" })), this.showHeader && (h("div", { key: 'f5675e917f299a2b2d9279ef6b4d06c21696e32a', class: "tooltip-header" }, h("div", { key: 'f2317e5f214ca6bcf92ad314840013e2f298c203', ref: el => this.headerSlotTarget = el }))), h("div", { key: 'e4e5a79aeddaa5e00d60f3b12e96c169f147dae8', class: "tooltip-content" }, this.loading ? (h("div", { class: "tooltip-loading-spinner" }, h("ui-icon", { name: "loader", library: "lucide", spin: true }), h("span", null, "Loading..."))) : (this.html ? (h("div", { innerHTML: sanitizeHTML(this.content) })) : (h("span", null, this.content))), h("div", { key: '87c26e2908df6ee6652d22e219dddc6c6f8ad36e', class: "tooltip-slot-content", ref: el => this.defaultSlotTarget = el })), this.showFooter && (h("div", { key: '9fe03747ba4fe5f3fcccede2c49540a9a7c9d696', class: "tooltip-footer" }, h("div", { key: 'f55cc3ddbfbcaf0e45e03dcb1971b696cd566150', ref: el => this.footerSlotTarget = el }))), this.arrow && h("div", { key: '30d603a7d56a57fca73c3cb9a6420cdabde31ead', class: "tooltip-arrow" })));
        return (h(Host, { key: '51577771914e7712be4e008b3cfa79683b06e3c2' }, h("div", { key: 'a5240a2c60d7dc9e2207d9c95fc8b860ab67efa1', class: "tooltip-wrapper" }, h("slot", { key: 'ce3a6106b2e281774e0281a5f72aeaa9fd84a37a', name: "target" })), this.isVisible && tooltipContent, h("div", { key: '91c1f89da5c9e24779a874d61862d02fa332749b', class: "tooltip-slot-source", style: { display: 'none' }, "aria-hidden": "true" }, h("div", { key: '2ed6c8792820b8306ba30083dc62528cf935092b', ref: el => this.defaultSlotSource = el }, h("slot", { key: 'd7b2237ccecaa53b6f3bf2afb87763abcec4fb20' })), h("div", { key: '9844aa3ec9a673f9ff2fc3fe20f350d3c3163f30', ref: el => this.headerSlotSource = el }, h("slot", { key: '538fdd565105d73df273bcdcc4e4d147b333deed', name: "header" })), h("div", { key: '2f6a44286d07483e4698b140fb22fa0c2c5d1b3b', ref: el => this.footerSlotSource = el }, h("slot", { key: '07c51076ab6df9792bdb737976f8b052908c5cfb', name: "footer" })))));
    }
