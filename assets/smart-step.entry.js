...
const SmartStep = class {
    ...
    label;
    /**
     * Whether the step is valid/finished (optional status indicator)
     */
    status = 'default';
    /**
    ...
    description;
    /**
     * Optional icon/number to display.
     * If not provided, parent SmartStepper can provide an index.
     */
    icon;
    /**
...
export { SmartStep as smart_step };
