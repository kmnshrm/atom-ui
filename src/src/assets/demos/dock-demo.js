...
export function initDockDemo() {
  ...
  section.innerHTML = `
    ...
    <div class="demo-controls" style="margin: 20px 0; display: flex; gap: 10px; flex-wrap: wrap;">
      <ui-button id="btnDockPlayground"  label="🎮 Interactive Playground" style="--btn-bg: #8b5cf6;" variant="outline"></ui-button>
      ...
      <ui-button id="btnDockPremium"  label="✨ OS Experience" style="--btn-bg: #ec4899;" variant="outline"></ui-button>
    </div>
