          ...
          ${[
            ...
            .map(
              ...
              <div style="padding: 25px; border: 1px solid #e2e8f0; border-radius: 12px; background: white; transition: transform 0.2s, box-shadow 0.2s; cursor: default;" onmouseover="this.style.transform='translateY(-4px)';this.style.boxShadow='0 10px 15px -3px rgba(0,0,0,0.1)';" onmouseout="this.style.transform='translateY(0)';this.style.boxShadow='none';">
                ...
                <p style="margin-top: 15px; font-size: 11px; font-weight: 800; text-transform: uppercase; color: #1e293b; letter-spacing: 0.05em;">${type.replace('-', ' ')}</p>
              </div>
            `,
            )
            .join('')}
  ...
  window.showLoaderSizes = function () {
    ...
    container.innerHTML = `
      <div class="demo-block">
        ...
        <div style="display: flex; gap: 30px; align-items: center; justify-content: center; flex-wrap: wrap; padding: 40px; background: white; border-radius: 12px; border: 1px solid #e2e8f0;">
  ...
  window.showPremiumFeatures = function () {
    ...
    container.innerHTML = `
      <div style="display: flex; flex-direction: column; gap: 40px;">
        ...
        <div class="demo-block" style="padding: 30px; border: 1px solid #e2e8f0; border-radius: 12px; background: white;">
          <h4 style="margin: 0 0 10px 0; color: #8b5cf6;">🗣️ Intelligent Message Rotation</h4>
          <p style="font-size: 14px; color: #64748b; margin-bottom: 24px;">Enhance perceived performance by rotating through status updates. Perfect for long processes.</p>
        ...
        <!-- Predictive Progress -->
        <div class="demo-block" style="padding: 30px; border: 1px solid #e2e8f0; border-radius: 12px; background: white;">
          <h4 style="margin: 0 0 10px 0; color: #8b5cf6;">🔋 Weighted Predictive Progress</h4>
          <p style="font-size: 14px; color: #64748b; margin-bottom: 24px;">The progress bar automatically "crawls" at realistic, non-linear speeds towards 95%, keeping users engaged.</p>
        ...
        <div class="demo-block" style="padding: 30px; border: 1px solid #e2e8f0; border-radius: 12px; background: white;">
          <h4 style="margin: 0 0 10px 0; color: #8b5cf6;">📐 Linear Strip Variant</h4>
          <p style="font-size: 14px; color: #64748b; margin-bottom: 24px;">Minimalist top-bar progress, similar to YouTube or GitHub navigation.</p>
          ...
          <div style="position: relative; height: 100px; border: 1px dashed #cbd5e1; border-radius: 8px; display: flex; align-items: center; justify-content: center;">
            <p style="font-size: 12px; color: #94a3b8;">(See the thin success line at the top of this box)</p>
            <ui-loader 
  ...
  window.showInteractiveLoader = function () {
    ...
    container.innerHTML = `
      <div class="demo-block">
        ...
        <p style="margin-bottom: 20px; font-size: 14px; color: #666;">Configure every single property of the <code>ui-loader</code> component in real-time.</p>
        
        <div class="playground-layout" style="display: grid; grid-template-columns: 350px 1fr; gap: 30px;">
          <!-- Controls Panel -->
          <div class="controls-panel" style="background: #f8fafc; padding: 20px; border-radius: 12px; border: 1px solid #e2e8f0; max-height: 80vh; overflow-y: auto;">
            
            <section style="margin-bottom: 24px;">
              <h4 style="margin: 0 0 12px 0; font-size: 13px; text-transform: uppercase; color: #64748b; letter-spacing: 0.05em;">Core Settings</h4>
            ...
            <section style="margin-bottom: 24px;">
              <h4 style="margin: 0 0 12px 0; font-size: 13px; text-transform: uppercase; color: #64748b; letter-spacing: 0.05em;">Content & Text</h4>
              <div style="display: grid; gap: 12px;">
                <div>
            ...
            <section style="margin-bottom: 24px;">
              <h4 style="margin: 0 0 12px 0; font-size: 13px; text-transform: uppercase; color: #64748b; letter-spacing: 0.05em;">Behavior</h4>
              <div style="display: grid; gap: 12px;">
            ...
            <section>
              <h4 style="margin: 0 0 12px 0; font-size: 13px; text-transform: uppercase; color: #64748b; letter-spacing: 0.05em;">Premium & Advanced</h4>
              <div style="display: grid; gap: 12px;">
                <div>
                ...
                <div>
                  ...
                  <ui-input type="text" id="pImage" value="https://cdn-icons-png.flaticon.com/512/9333/9333991.png" >
                </div>
          ...
          <div class="display-panel" style="display: flex; flex-direction: column; gap: 20px;">
            <div id="pReviewContainer" style="flex: 1; min-height: 400px; background: white; border: 1px solid #e2e8f0; border-radius: 12px; position: relative; display: flex; align-items: center; justify-content: center; overflow: hidden; background-image: radial-gradient(#e2e8f0 1px, transparent 1px); background-size: 20px 20px;">
               <div id="pOutput"></div>
            </div>
  ...
  window.showRainingLetters = function () {
    ...
    container.innerHTML = `
      <div class="demo-block">
        ...
        <p style="font-size: 13px; color: #64748b; margin-bottom: 24px;">Use <code>rain-text</code> to define which characters rain and <code>rain-columns</code> to control column count.</p>
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 20px; text-align: center; padding: 20px;">
          <div style="padding: 24px; border: 1px solid #e2e8f0; border-radius: 12px; background: white;">
            <ui-loader type="raining-letters" size="xl" color="primary"></ui-loader>
            <p style="margin-top: 12px; font-size: 11px; font-weight: 700; color: #64748b;">Default (A–Z 0–9)</p>
            <code style="font-size: 10px; color: #94a3b8;">type="raining-letters"</code>
          </div>
          <div style="padding: 24px; border: 1px solid #e2e8f0; border-radius: 12px; background: white;">
            <ui-loader type="raining-letters" size="xl" color="#10b981" rain-text="01"></ui-loader>
            <p style="margin-top: 12px; font-size: 11px; font-weight: 700; color: #64748b;">Binary Matrix</p>
            <code style="font-size: 10px; color: #94a3b8;">rain-text="01"</code>
          </div>
          <div style="padding: 24px; border: 1px solid #e2e8f0; border-radius: 12px; background: white;">
            <ui-loader type="raining-letters" size="xl" color="#8b5cf6" rain-text="★♦♣♠♥" rain-columns="5"></ui-loader>
            <p style="margin-top: 12px; font-size: 11px; font-weight: 700; color: #64748b;">Symbols</p>
            <code style="font-size: 10px; color: #94a3b8;">rain-text="★♦♣♠♥"</code>
          </div>
          <div style="padding: 24px; border: 1px solid #e2e8f0; border-radius: 12px; background: white;">
            <ui-loader type="raining-letters" size="xl" color="#ef4444" rain-text="Loading" rain-columns="7"></ui-loader>
            <p style="margin-top: 12px; font-size: 11px; font-weight: 700; color: #64748b;">Custom word, 7 cols</p>
            <code style="font-size: 10px; color: #94a3b8;">rain-text="Loading" rain-columns="7"</code>
          </div>
          <div style="padding: 24px; border: 1px solid #e2e8f0; border-radius: 12px; background: white;">
            <ui-loader type="raining-letters" size="xl" color="#f59e0b" rain-text="ABCDEF" rain-columns="3"></ui-loader>
            <p style="margin-top: 12px; font-size: 11px; font-weight: 700; color: #64748b;">3 columns</p>
            <code style="font-size: 10px; color: #94a3b8;">rain-columns="3"</code>
          </div>
        </div>
      </div>
    `;
