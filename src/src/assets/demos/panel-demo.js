...
export function initPanelDemo() {
  ...
  window.showDraggable = function () {
    panelDemoArea.innerHTML = `
      <div class="demo-block">
        ...
        <div style="position: relative; height: 500px; background: #f9fafb; border-radius: 8px; padding: 16px;">
          <ui-panel 
  ...
  window.showPlayground = function () {
    panelDemoArea.innerHTML = `
      <div class="demo-block playground-block" style="padding: 0; overflow: hidden; border-radius: 12px; background: #0f172a; border: 1px solid #334155; display: grid; grid-template-columns: 320px 1fr; height: 700px;">
        <!-- Controls -->
        <div class="playground-controls" style="padding: 20px; background: #1e293b; border-right: 1px solid #334155; overflow-y: auto; color: #f1f5f9; scrollbar-width: thin;">
          <h4 style="margin: 0 0 20px 0; color: #10b981; text-transform: uppercase; font-size: 12px; letter-spacing: 1px; border-bottom: 1px solid rgba(59, 130, 246, 0.2); padding-bottom: 5px;">✨ Visuals</h4>
          ...
          <div style="margin-bottom: 12px;">
            <label style="display: block; font-size: 11px; color: #94a3b8; margin-bottom: 4px; text-transform: uppercase;">Background Color</label>
          ...
          <div style="margin-top: 20px; background: #0f172a; padding: 12px; border-radius: 6px; position: relative;">
             <ui-button onclick="copyPanelCode()" id="copyPanelBtn" style="position: absolute; top: 6px; right: 6px; background: rgba(255,255,255,0.1); color: white; border: none; padding: 2px 6px; border-radius: 4px; font-size: 10px; cursor: pointer;">Copy</ui-button>
             <code id="panelCodeBlock" style="color: #e2e8f0; font-family: monospace; font-size: 11px; display: block; overflow-x: auto; white-space: pre-wrap;"></code>
          </div>
        </div>

        <!-- Canvas -->
        <div id="playCanvas" style="position: relative; padding: 40px; background-image: radial-gradient(#334155 1px, transparent 1px); background-size: 20px 20px; display: flex; align-items: center; justify-content: center; overflow: hidden; background-color: #0f172a;">
          <ui-panel 
            id="playPanel"
          ...
          >
            <div slot="content">
              <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 15px;">
                ...
                <div>
                  <h4 style="margin: 0; color: #fff; font-size: 15px;">Live Playground</h4>
                  <p style="margin: 0; color: #94a3b8; font-size: 12px;">Premium ui-panel component</p>
                </div>
              </div>
        ...
        <div style="margin-top: 20px; background: #1e293b; padding: 16px; border-radius: 8px; position: relative;">
          <ui-button onclick="copyPanelCode()" id="copyPanelBtn" style="position: absolute; top: 10px; right: 10px; background: rgba(255,255,255,0.1); color: white; border: none; padding: 4px 10px; border-radius: 4px; font-size: 11px; cursor: pointer; transition: all 0.2s;">Copy</ui-button>
          <code id="panelCodeBlock" style="color: #e2e8f0; font-family: monospace; font-size: 13px; display: block; overflow-x: auto; padding-right: 50px; white-space: pre-wrap;">
            <ui-panel ...></ui-panel>
          </code>
        </div>
      </div>
    ...
    panelDemoArea.innerHTML = `
      <div class="demo-block">
        ...
        <div style="display: flex; gap: 16px; flex-wrap: wrap;">
          ...
          <!-- Glass Panel Trigger -->
          <div style="flex: 1; min-width: 250px; padding: 20px; background: url('https://images.unsplash.com/photo-1557683316-973673baf926?auto=format&fit=crop&w=500&q=80') center/cover; border-radius: 8px; text-align: center;">
    ...
    window.openModalPanel = function () {
      ...
      panel.innerHTML = `
            <div slot="content" style="text-align: center; padding: 20px;">
                <div style="background: #eff6ff; width: 60px; height: 60px; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 16px;">
                ...
                ${menuItems
                  .map(
                    ...
                    <div style="padding: 12px 16px; display: flex; align-items: center; justify-content: space-between; cursor: pointer; transition: background 0.2s;" onmouseover="this.style.backgroundColor='#f9fafb'" onmouseout="this.style.backgroundColor='transparent'">
                        ...
                        ${item.badge ? `<span style="background: #ef4444; color: white; font-size: 11px; padding: 2px 6px; border-radius: 10px; font-weight: 600;">${item.badge}</span>` : '<span style="color: #9ca3af;">›</span>'}
                    </div>
                `,
                  )
                  .join('')}
  ...
  window.showAllFeatures = function () {
    panelDemoArea.innerHTML = `
      <div class="demo-block">
        ...
        <div style="position: relative; height: 600px; background: #f9fafb; border-radius: 8px; padding: 16px;">
          <ui-panel 
          ...
          >
            <div slot="content">
              ...
              <p style="margin-top: 16px; padding: 12px; background: #eff6ff; border-radius: 6px; border-left: 4px solid #10b981;">
