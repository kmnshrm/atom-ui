...
export function initFabDemo() {
  ...
  section.innerHTML = `
    ...
    <div id="fabDemoContainer" style="margin-top: 20px; min-height: 400px; position: relative; border: 1px dashed #e2e8f0; border-radius: 12px; padding: 20px; overflow: hidden; background: rgba(255,255,255,0.02);">
       <div id="fabContent" style="text-align: center; padding: 100px 20px; color: #64748b;">
  ...
  const showFloatingWindowDemo = function () {
    ...
    fab.innerHTML = `
      <div slot="panel" style="display: flex; flex-direction: column; gap: 15px;">
        <div style="background: #f8fafc; padding: 10px; border-radius: 8px; font-size: 13px; align-self: flex-start; max-width: 80%;">
    ...
    content.innerHTML = `
      <div style="text-align: left; max-width: 400px; margin: 0 auto; background: rgba(255,255,255,0.05); padding: 20px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.1);">
        ...
        <div style="margin-bottom: 12px;">
          <label style="display: block; font-size: 12px; margin-bottom: 4px; color: #94a3b8;">Variant</label>
        ...
        <div style="margin-bottom: 12px;">
          <label style="display: block; font-size: 12px; margin-bottom: 4px; color: #94a3b8;">Position</label>
        ...
        <div style="margin-bottom: 12px;">
          <label style="display: block; font-size: 12px; margin-bottom: 4px; color: #94a3b8;">Size</label>
