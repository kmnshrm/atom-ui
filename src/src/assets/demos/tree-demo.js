...
export function initTreeDemo() {
  ...
  section.innerHTML = `
    ...
    <div class="demo-controls" style="display:flex; gap:10px; flex-wrap:wrap; margin-bottom:24px;">
      ...
      <ui-button onclick="window.showTreeDND()"  variant="outline" color="warning" label="Drag & Drop" icon="move" library="lucide"></ui-button>
      <ui-button onclick="window.showTreeOrgChart()" variant="outline" color="primary" label="Org Chart" icon="users" library="lucide" style="background:#8b5cf6;"></ui-button>
      <ui-button onclick="window.showTreeAesthetics()" variant="outline" color="info" label="Aesthetics" icon="palette" library="lucide" style="background:#14b8a6;"></ui-button>
      <ui-button onclick="window.showTreeStress()" variant="outline" color="danger" label="Stress Test" icon="flame" library="lucide"></ui-button>
      <ui-button onclick="window.showTreeGitGraph()" variant="outline" color="secondary" label="Git Graph" icon="git-branch" library="lucide" style="background:#64748b;"></ui-button>
      <ui-button onclick="window.showTreeIcons()" variant="outline" color="warning" label="Custom Icons" icon="plus" library="lucide"></ui-button>
      <ui-button onclick="window.showTreePlayground()" variant="outline" color="primary" label="Playground" icon="gamepad-2" library="lucide" style="background:#6366f1;"></ui-button>
    </div>
