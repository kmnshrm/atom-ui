                ...
                },
                {
                  ...
                  children: [
                    ...
                    },
                    {
                      ...
                      title: 'Preview',
                      icon: 'eye',
                      content: '<div style="padding: 20px; background: #f0fdf4; height: 100%;"><h3>Preview Panel</h3><p>Live preview of changes</p></div>',
                      closable: true,
                    },
                  ],
                },
            ...
            },
            {
              ...
              children: [
                ...
                },
                {
                  ...
                  icon: 'bell',
                  content: `<div style="padding: 20px; height: 100%;">
                    <div style="margin-bottom: 15px; padding: 12px; background: #f0fdf4; border-left: 3px solid #10b981;">
                      <strong>New user registration</strong>
                      <div style="color: #6b7280; font-size: 13px; margin-top: 3px;">2 minutes ago</div>
                    </div>
                    <div style="margin-bottom: 15px; padding: 12px; background: #eff6ff; border-left: 3px solid #10b981;">
                  ...
                  children: [
                    {
                      ...
                      icon: 'folder',
                      size: 20,
                      content: `<div style="padding: 15px; height: 100%; overflow-y: auto; background: #f9fafb;">
                        <div style="margin-bottom: 8px;">
                          <ui-input type="text" placeholder="Search files..." style="width: 100%; padding: 8px; border: 1px solid #e5e7eb; border-radius: 6px; font-size: 12px;" />
                        </div>
                        <div style="margin-top: 15px;">
                          ...
                          <div style="margin-left: 15px;">
                            ...
                            <div style="margin-left: 15px;">
                              <div style="padding: 6px; cursor: pointer; border-radius: 4px; font-size: 12px; color: #374151; background: #dbeafe; font-weight: 600; display: flex; align-items: center; gap: 5px;">
                    ...
                    },
                    {
                      ...
                      content: `<div style="padding: 0; height: 100%; background: #1f2937;">
                        <div style="background: #111827; padding: 8px 16px; border-bottom: 1px solid #374151; display: flex; justify-content: space-between; align-items: center;">
...
<span style="color: #9ca3af;">16</span> }</code></pre>
                ...
                },
                {
                  ...
                  children: [
                    ...
                    },
                    {
                      ...
                      title: 'Problems',
                      icon: 'alert-triangle',
                      content: `<div style="padding: 15px; height: 100%; overflow-y: auto; background: white;">
                        <div style="padding: 10px; background: #fef3c7; border-left: 3px solid #f59e0b; border-radius: 4px; margin-bottom: 10px;">
                          <div style="font-weight: 600; color: #92400e; font-size: 13px; display: flex; align-items: center; gap: 5px;"><span><ui-icon name="alert-triangle" library="lucide" size="14px"></ui-icon></span> Warning</div>
                          <div style="color: #78350f; font-size: 12px; margin-top: 4px;">Unused variable 'temp' at line 23</div>
                        </div>
                        <div style="padding: 10px; background: #dbeafe; border-left: 3px solid #10b981; border-radius: 4px;">
                          <div style="font-weight: 600; color: #1e40af; font-size: 13px; display: flex; align-items: center; gap: 5px;"><span><ui-icon name="info" library="lucide" size="14px"></ui-icon></span> Info</div>
              ...
              children: [
                {
                  ...
                  content: `<div style="padding: 20px; height: 100%; display: flex; flex-direction: column; background: linear-gradient(to bottom, #f9fafb 0%, #ffffff 100%);">
                    <div style="flex: 1; overflow-y: auto; margin-bottom: 15px; padding: 15px; background: white; border-radius: 8px; border: 1px solid #e5e7eb;">
                      <div style="margin-bottom: 15px; padding: 12px; background: #eff6ff; border-radius: 8px; border-left: 3px solid #10b981;">
                      ...
                      <div style="margin-bottom: 15px; padding: 12px; background: #f0fdf4; border-radius: 8px; border-left: 3px solid #10b981;">
  ...
  constructor(value) {
    ...
    this.right = null;
                    ...
                    <div style="display: flex; gap: 8px;">
                      <ui-input type="text" placeholder="Ask Copilot anything..." style="flex: 1; padding: 10px; border: 1px solid #e5e7eb; border-radius: 6px; font-size: 14px;" />
                ...
                },
                {
                  ...
                  content: `<div style="padding: 20px; height: 100%; overflow-y: auto;">
                    ...
                    <div style="margin-bottom: 20px;">
                      <div style="padding: 10px; background: #f9fafb; border-radius: 6px; margin-bottom: 8px; border: 1px solid #e5e7eb; cursor: pointer;" onmouseover="this.style.background='#f3f4f6'" onmouseout="this.style.background='#f9fafb'">
                    ...
                    <div style="display: flex; flex-direction: column; gap: 8px;">
                      <ui-button style="padding: 8px 12px; background: white; border: 1px solid #e5e7eb; border-radius: 6px; text-align: left; cursor: pointer; font-size: 13px; color: #374151;" onmouseover="this.style.background='#f9fafb'" onmouseout="this.style.background='white'">
...
window.showAPIReference = function () {
  ...
  closable: true
          ...
          <div style="background: #f9fafb; padding: 20px; border-radius: 8px; border: 1px solid #e5e7eb;">
            <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 10px;">
              <code style="background: #ef4444; color: white; padding: 4px 8px; border-radius: 4px; font-size: 14px;">removePanel</code>
            ...
            <pre style="background: #1f2937; color: #ef4444; padding: 15px; border-radius: 6px; margin-top: 10px; overflow-x: auto;"><code>await manager.removePanel('panel-1');</code></pre>
          </div>
...
localStorage.setItem('myLayout', layout);</code></pre>
          ...
          <div style="background: #f9fafb; padding: 20px; border-radius: 8px; border: 1px solid #e5e7eb;">
            <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 10px;">
              <code style="background: #f59e0b; color: white; padding: 4px 8px; border-radius: 4px; font-size: 14px;">loadLayout</code>
            ...
            <pre style="background: #1f2937; color: #f59e0b; padding: 15px; border-radius: 6px; margin-top: 10px; overflow-x: auto;"><code>const saved = localStorage.getItem('myLayout');
