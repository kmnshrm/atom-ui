...
export const categoryNavItems: NavItem[] = [
  {
    ...
    children: [
      ...
      { id: "toolbar", label: "Toolbar", icon: "panel-top", iconLibrary: "lucide" },
      { id: "top-bar", label: "Top Bar", icon: "layout-template", iconLibrary: "lucide" },
      { id: "workspace-manager", label: "Workspace Manager", badge: "✨", icon: "app-window", iconLibrary: "lucide" },
    ],
  },
  {
    id: "navigation",
    ...
    children: [
      ...
      { id: "command-palette", label: "Command Palette", icon: "terminal-square", iconLibrary: "lucide" },
      { id: "fab", label: "FAB", icon: "plus-circle", iconLibrary: "lucide" },
      { id: "horizontal-nav", label: "Horizontal Nav", icon: "navigation", iconLibrary: "lucide" },
      { id: "stepper", label: "Stepper", icon: "milestone", iconLibrary: "lucide" },
      { id: "smart-menu", label: "Smart Menu", icon: "menu-square", iconLibrary: "lucide" },
    ],
  },
  {
    id: "inputs",
    ...
    children: [
      ...
      { id: "button-toggle-group", label: "Button Toggle Group", icon: "toggle-left", iconLibrary: "lucide" },
      { id: "checkbox-group", label: "Checkbox Group", icon: "check-square", iconLibrary: "lucide" },
      { id: "color-controller", label: "Color Controller", icon: "palette", iconLibrary: "lucide" },
      { id: "color-picker", label: "Color Picker", icon: "pipette", iconLibrary: "lucide" },
      { id: "drag-drop", label: "Drag & Drop", icon: "move", iconLibrary: "lucide" },
      { id: "file-upload", label: "File Upload", icon: "upload", iconLibrary: "lucide" },
      { id: "image-button", label: "Image Button", icon: "image", iconLibrary: "lucide" },
      { id: "input-pair", label: "Input Pair", icon: "columns-2", iconLibrary: "lucide" },
      { id: "number-input", label: "Number Input", icon: "hash", iconLibrary: "lucide" },
      { id: "radio-group", label: "Radio Group", icon: "radio", iconLibrary: "lucide" },
      { id: "toggle-group", label: "Toggle Group", icon: "toggle-right", iconLibrary: "lucide" },
      { id: "smart-location-dropdown", label: "Smart Location", icon: "map-pin", iconLibrary: "lucide" },
      // {
      //   id: "toggle",
      //   label: "Toggle",
      //   icon: "toggle-left",
  ...
  },
  {
    ...
    children: [
      ...
      { id: "list-group", label: "List Group", icon: "list-tree", iconLibrary: "lucide" },
      // {
      //   id: "tree-list",
      //   label: "Tree List",
      //   icon: "git-branch",
  ...
  },
  {
    ...
    children: [
      ...
      { id: "code-preview", label: "Code Preview", icon: "code", iconLibrary: "lucide" },
      { id: "icon", label: "Icon", icon: "shapes", iconLibrary: "lucide" },
      { id: "tag-group", label: "Tag Group", icon: "tags", iconLibrary: "lucide" },
    ],
  },
  {
    id: "overlays",
