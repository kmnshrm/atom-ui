...
export const COMPONENTS = [
  ...
  { id: 'drag-drop', label: '↕️ Drag Drop', icon: '↕️' },
 ...
 // { id: 'picklist', label: '📋 Picklist', icon: '📋' },
  ...
  { id: 'callout-banner', label: '📣 Callout Banner', icon: '📣' },
 ...
 // { id: 'cascade-select', label: '🔽 Cascade Select', icon: '🔽' },
  ...
  { id: 'layout-manager', label: '🏗️ Layout Manager', icon: '🏗️' },
  { id: 'animate-on-scroll', label: '✨ Animate on Scroll', icon: '✨' },
  { id: 'list', label: '📋 List', icon: '📋' },
  { id: 'label', label: '🏷️ Label', icon: '🏷️' },
];
