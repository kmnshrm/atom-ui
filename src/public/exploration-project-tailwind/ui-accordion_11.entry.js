...
const NavigationBar = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'b391479f90ee73fd71c17631811f4a1c3ecfa1c0', style: vars, class: hostClass, "data-theme": this.effectiveTheme }, h("div", { key: '51fb81d0db730c41107593790ae16b857bf5c8dd', class: "nav-glider", style: {
            ...
            } }), this.renderToggle(), this.isMobile && this.isExpanded && h("div", { key: 'f55a17351bb19963672f550ca86028bc5541bf45', class: "nav-backdrop", onClick: () => this.close() }), h("div", { key: '5a3399dc0226029ce294a312525d8fdb48811fd5', class: "nav-blocks-container" }, h("div", { key: 'd6292692d334b16051c3651cb3797ca6bf59539a', class: "nav-header" }, h("slot", { key: '5d40250776f7cd676c4f140c7ed35d6c22853d50', name: "header" }, (this.companyLogo || this.companyName) && (h("div", { key: 'cddf6ba874bcb64b47e9027c59d67d8e8e0f70f3', class: "nav-company-block", style: { display: 'flex', alignItems: 'center', gap: '12px', padding: '0 24px', height: '64px' } }, this.companyLogo && h("img", { key: 'abdb70c6f175d16533affdbb616583bc7d3ca1fe', src: this.companyLogo, alt: this.companyName || 'Logo', style: { height: '32px', width: 'auto' } }), this.isExpanded && this.companyName && (h("span", { key: '5d82890db7cc0249875004d66602262de55db51b', class: "nav-company-name", style: { fontWeight: '600', fontSize: '16px' } }, this.companyName))))), h("slot", { key: 'a794b45c2134bb293a3ff8ad5a83f2fca7861e91', name: "logo" }), this.isMobile && (h("div", { key: '236b5edae480b453ee99b952b007c067ef4a7b68', class: "nav-mobile-close", onClick: () => this.close() }, h("svg", { key: '00a6de9968da391d0248808d823fe60833725686', viewBox: "0 0 24 24", width: "24", height: "24", stroke: "currentColor", fill: "none" }, h("path", { key: '86c21abc9582cd9802aefbe3730b70b476d2ffe0', d: "M18 6L6 18M6 6l12 12" }))))), this.showSearch && this.isExpanded && (h("div", { key: '1e9d00637cbf427795c50186bca4515ac4822931', class: "nav-search-bar" }, h("div", { key: '2571b44eb8de7cab36a53200c5f655077390634a', style: {
                position: 'relative',
                display: 'flex',
                alignItems: 'center',
                ...
                borderRadius: '6px',
                padding: '4px 8px',
            } }, h("svg", { key: 'fb98d8a8c9b99ac16be3b1158eae998f278542eb', viewBox: "0 0 24 24", width: "16", height: "16", fill: "none", stroke: "currentColor", "stroke-width": "2", style: { opacity: '0.5', marginRight: '8px' } }, h("circle", { key: 'd045cae9b200aabf88f58408db1da8814037ec98', cx: "11", cy: "11", r: "8" }), h("line", { key: '13148423f101beec4702e0f734fbfb6cc0f989e4', x1: "21", y1: "21", x2: "16.65", y2: "16.65" })), h("input", { key: '594e488974586393c508480aacbdfd2631a56c23', type: "text", placeholder: "Search...", value: this.keyword, onInput: e => (this.keyword = e.target.value), style: {
                ...
                fontSize: '14px',
                color: 'inherit',
            } })))), blocks.categories.length > 0 && (h("div", { key: '901772ca1a8c214419405a9241c5b3855d74ac00', class: "nav-block-categories", role: "tree" }, this.renderNavList(blocks.categories, 'cat'))), h("div", { key: 'b0fff94a785fcfeb2f1881d10fbc47b30b171d93', class: "nav-block-top", role: "tree" }, this.renderNavList(blocks.primary, 'top'), h("slot", { key: 'be4437d51ac4336925c8cbd9726ccfa30755b15b', name: "menu-item" }), " ", blocks.primary.length === 0 && blocks.categories.length === 0 && blocks.secondary.length === 0 && h("slot", { key: '94726eac09f917097e8ab85fc27086f5c1e96f3f', name: "empty-state" }, "No Items")), blocks.secondary.length > 0 && (h("div", { key: '844916dc9d9cdbffedcd72fa01e4cc75f3025358', class: "nav-block-secondary", role: "tree" }, this.renderNavList(blocks.secondary, 'sec'))), blocks.bottom.length > 0 && (h("div", { key: '94e44d737234051eecee4350b7b430ea77366c8a', class: "nav-block-bottom", role: "tree" }, blocks.bottom.map(item => this.renderItem(item)), h("slot", { key: 'ae336a31c6849d733ecd733f4121153e3caf6ea2', name: "footer" }))), blocks.bottomSecondary.length > 0 && (h("div", { key: 'c042918ad0d9f49e1c7d7915c702307968e01eb2', class: "nav-block-profile", role: "tree" }, blocks.bottomSecondary.map(item => this.renderItem(item)))))));
    }
    isBottomItem(id) {
        const blocks = this.getBlocks();
